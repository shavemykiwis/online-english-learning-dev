      ...
      >
        ...
        >
          ...
          {this.props.navCollapsed ? (
            <i
              className="material-icons hide-menu-controls-on-mobile"
              style={{ cursor: "pointer" }}
              onClick={() => this.onToggleMenuItem(false)}
            >
              view_headline
            </i>
          ) : null}
          ...
          {!this.props.navCollapsed ? (
            <i
              className="material-icons hide-menu-controls-on-mobile"
              onClick={() => this.onToggleMenuItem(true)}
          ...
          {/* {this.props.navCollapsed & <i className='material-icons'>bookmark</i>} */}
        </section>

        <section className="sidebar-content" style={styles.sidebarContent}>
          <SidenavContent />
        </section>
