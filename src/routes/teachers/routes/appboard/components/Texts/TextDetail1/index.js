    ...
    return (
      <div style={styles.wordBar}>
        ...
        >
          {selectedWord !== undefined && (
            <div>
              <span style={styles.wordBarText1}>{selectedWord.word}</span>
              &nbsp;&nbsp;
              <span style={styles.wordBarText2}>
                ({selectedWord.pronouncation})
              </span>
            </div>
          )}
          ...
          {selectedWord !== undefined && (
            <div>
              <span style={styles.wordBarText1}>{selectedWord.meaning}</span>
              &nbsp;&nbsp;
              <span style={styles.wordBarText2}>({selectedWord.type})</span>
            </div>
          )}
        </div>
        <div>
