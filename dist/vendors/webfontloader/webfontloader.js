/* Web Font Loader v1.6.27 - (c) Adobe Systems, Google. License: Apache 2.0 */ (function() {
  ...
  function t(a, b, c, d) {
    ...
    if (c)
      for (const e in c)
        c.hasOwnProperty(e) &&
          (e == "style" ? (b.style.cssText = c[e]) : b.setAttribute(e, c[e]));
  ...
  ua.prototype.load = function(a) {
    ...
    for (c = e.length; b < c; b++)
      if (((d = e[b].split(":")), d[1]))
        for (let h = d[1].split(","), m = 0; m < h.length; m += 1)
  ...
  const Ha = { Arimo: !0, Cousine: !0, Tinos: !0 };
          ...
          b => {
            if (b) a([]);
              ...
              for (var e = [], f = 0; f < b.length; f += 2)
                for (let g = b[f], k = b[f + 1], h = 0; h < k.length; h++)
                  e.push(new H(g, k[h]));
              try {
